...
import com.pinto.mymovieappkt.databinding.ItemTrendingTvBinding
import com.pinto.mymovieappkt.databinding.ItemTvBinding
...
class TvAdapter(
    ...
    inner class TrendingViewHolder private constructor(val view: ItemTrendingTvBinding) :
        RecyclerView.ViewHolder(view.root) {
        constructor(parent: ViewGroup) : this(
            ItemTrendingTvBinding.inflate(
                LayoutInflater.from(
                    parent.context
                ), parent, false
            )
